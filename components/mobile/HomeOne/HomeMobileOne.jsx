    ...
    return (
        <div className='w-full relative  flex flex-col justify-center items-center pb-4 mt-40'>
            ...
            >
                ...
                <div className='w-full h-3/4 flex justify-start sm:justify-center items-center sm:gap-x-8 gap-x-2'>
                    <div className='h-full relative flex flex-col gap-y-4 ' style={{ width: "200px" }}>
                        ...
                        <div className='w-full flex flex-col px-2 gap-y-2 justify-center items-center'>
                            ...
                            <span className='w-full sm:text-lg text-center text-sm'>
            ...
            <motion.div
                ref={section5Ref}
                className='w-full px-2 sm:px-8 flex sm:mt-10 justify-between items-center bg-gray-400'
                style={{ height: "80px" }}
                initial={{ opacity: 0, y: 20 }}
            ...
            >
                ...
                <div className='flex sm:gap-x-8 gap-x-4'>
                    <div className='w-6 h-6 sm:w-8 sm:h-8 cursor-pointer'>
