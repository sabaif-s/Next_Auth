...
const HomeDesktopOne = () => {
    ...
    return (
        <div className='w-full relative flex flex-col pb-4  mt-0'>
            ...
            <motion.div
                ref={section1Ref}
                className='w-full h-full flex justify-between items-center overflow-hidden bg-gray-400 px-8 py-6'
                initial={{ opacity: 0, y: 20 }}
                animate={isInView1 ? { opacity: 1, y: 0 } : { opacity: 0, y: 20 }}
                transition={{ duration: 0.8, ease: 'easeOut' }}
            >
                <div className='flex flex-col gap-y-2'>
                    <span className='text-white font-bold text-2xl xl:text-6xl'>
                        {data.sections[0].title}
                    </span>
                    <span className='text-yellow-600 font-semibold text-2xl xl:text-6xl font-bold'>
            ...
            >
                <div className='w-1/2'>
                                      <span className='text-3xl xl:text-4xl text-blue-400 font-bold'>
            ...
            <motion.div
                ref={section5Ref}
                className='w-full px-8 py-4 bg-gray-700 flex justify-between items-center'
                initial={{ opacity: 0, y: 20 }}
